 ...
 * @LastEditTime: 2023-05-04 17:49:35
 * @FilePath: /designauto/da-ent/ent-topology-optimaztion/top-regular-model/entry.cpp
...
int main(int argc, char **argv) {
  ...
  EntryProgram entry("top-mech-regular-model");
